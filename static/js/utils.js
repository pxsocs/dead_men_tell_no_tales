$(document).ready(function () {
    ...
    $(document).on('change', '#loader_select', function () {
        ...
        data = ajax_getter(base_url() + 'port_actions?action=get_portfolio&port_id=' + sel_port);
...
function load_portfolio() {
    ...
    var data = ajax_getter(base_url() +
        'port_actions?action=get_portfolio&port_id=' +
    ...
    try {
        ...
        url = '/analyze?portfolio=' + p + '&rebalance=' + r
...
function update_load_list(filter) {
    url = base_url() + 'port_actions?action=get_portfolios&filter=' + filter;
